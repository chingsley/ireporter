...
const emailTest = {
  ...
  verifyEmail(str) {
    ...
    for (let i = 0; i < lp.length; i++) {
      ...
      // console.log(x);
      const y = x + 1; // n is index of the next character following the current dot
      if (lp[x] === lp[y]) {
    ...
    for (let i = 0; i < dom.length; i++) {
      ...
      const n = m + 1; // n is index of the next character following the current dot
